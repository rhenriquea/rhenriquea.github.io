      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        <div className="relative">
          <div className="bg-surface-container-high p-6 border-l-[12px] poster-pink shadow-2xl">
            <div className="aspect-square bg-black relative overflow-hidden ring-4 ring-surface-container-high shadow-inner">
              <img
              ...
              />
              <div className="absolute inset-0 bg-accent-pink/20 mix-blend-overlay" />
            </div>
        ...
        <div className="flex flex-col gap-10">
          <div className="relative h-72 border-2 border-accent-cyan/30 bg-black p-6 shadow-[inset_0_0_40px_rgba(0,240,255,0.1)]">
            ...
            <div className="w-full h-full opacity-20 flex items-center justify-center font-chrome text-5xl italic tracking-widest text-accent-cyan">
              [ COORDS ]
            </div>
